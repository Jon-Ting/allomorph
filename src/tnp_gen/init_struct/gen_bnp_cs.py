...
from tnp_gen.constants import BNP_DIR, CS_DIR, DIAMETER_LIST, ELE_DICT, LMP_DATA_DIR, MNP_DIR, SHAPE_LIST
...
def write_hard_core_shell(replace=False, vis=False, ele_dict=None):
    """
